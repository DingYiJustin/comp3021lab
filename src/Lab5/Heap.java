...
parent.
    ...
    private void heapifyUp() {
        // TODO
    	int currentLastElementIndex = container.size()-1;
    	while(hasParent(currentLastElementIndex)) {
    		int parentIndex = getParentIndex(currentLastElementIndex);
    		if((container.get(currentLastElementIndex)).compareTo(container.get(parentIndex))== -1) {
    			swap(currentLastElementIndex, parentIndex);
    			currentLastElementIndex = parentIndex;
    		}
    		else {
    			break;
    		}
